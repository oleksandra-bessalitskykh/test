    ...
    return (
        <div className="hero-banner">
            ...
            <div className='hero-banner__description'>
                <p className='hero-banner__description__text'>Узнайте какими навыками должен обладать
                ...
                <ul className='hero-banner__description__authors'>
                  <li className='hero-banner__description__author'>
                    ...
                    <div>
                      <p className='hero-banner__description__author-name'> Кирилл Касатонов</p>
                      <p className='hero-banner__description__author-exp'>6 лет коммерческого опыта с такими компаниями как Mercedes-Benz и другими крупными корпорациями</p>
                    </div>
                  </li>
                  <li className='hero-banner__description__author'>
                    <img src={present} alt="time"/>
                    <div>
                      <p className='hero-banner__description__author-name'>Бонус за регистрацию</p>
                      <p className='hero-banner__description__author-exp'>PDF-файл "5 преимуществ профессии фронтенд разработчика"</p>
                    </div>
                  </li>
                </ul>
            </div>
